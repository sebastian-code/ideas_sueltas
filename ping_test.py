...
def recursive(dest_addr, count=10, timeout=1, verbose=False):
    """
...
if __name__ == '__main__':
    ...
    for ip in ips:
        ...
        print("")
    """
    recursive('google.com', 10, 2, True)
    print("")
    recursive('invalid-test-url.com', 10, 2, True)
    print("")
    recursive('127.0.0.1', 10, 2, True)
    """
